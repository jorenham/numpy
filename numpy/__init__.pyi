...
# TODO: use `typing.extensions.CapsuleType` instead
...
_ItemType_co = TypeVar("_ItemType_co", covariant=True, default=object)
...
class generic(_ArrayOrScalarCommon, Generic[_ItemType_co]):
    @abstractmethod
    ...
    def tolist(self, /) -> _ItemType_co: ...
    def item(self, args: L[0] | tuple[()] | tuple[L[0]] = ..., /) -> _ItemType_co: ...
...
_NumberType_co = TypeVar("_NumberType_co", int, float, complex, covariant=True, default=complex)

class number(generic[_NumberType_co], Generic[_NBit, _NumberType_co]):  # type: ignore
    def __class_getitem__(cls, item: Any, /) -> GenericAlias: ...
...
_BoolType = TypeVar("_BoolType", bound=builtins.bool)
_BoolType_co = TypeVar("_BoolType_co", bound=builtins.bool, covariant=True, default=builtins.bool)

_Falsy: TypeAlias = L[None, False, 0, b"", ""] | np.bool[L[False]] | integer[Any, L[0]]
_Truthy: TypeAlias = L[True, 1] | np.bool[L[True]] | integer[Any, L[1]]

class bool(generic[_BoolType_co], Generic[_BoolType_co]):
    @overload
    ...
    def __bool__(self, /) -> _BoolType_co: ...
    @overload
    ...
    @overload
    def __and__(self, other: _IntType, /) -> _IntType: ...
    @overload
    ...
    @overload
    def __and__(self, other: L[True] | np.bool[L[True]], /) -> np.bool[_BoolType_co]: ...
    @overload
    ...
    @overload
    def __xor__(self, other: _IntType, /) -> _IntType: ...
    @overload
    def __xor__(self: np.bool[L[False]], other: _BoolType | np.bool[_BoolType], /) -> np.bool[_BoolType]: ...
    @overload
    def __xor__(self, other: L[False] | np.bool[L[False]], /) -> np.bool[_BoolType_co]: ...
    @overload
    ...
    @overload
    def __or__(self, other: _IntType, /) -> _IntType: ...
    @overload
    def __or__(self: np.bool[L[True]], other: builtins.bool | np.bool, /) -> np.bool[L[True]]: ...
    @overload
    def __or__(self, other: L[False] | np.bool[L[False]], /) -> np.bool[_BoolType_co]: ...
    @overload
...
bool_: TypeAlias = bool[_BoolType_co]


# object_

@type_check_only
class _SimpleNestedSequence(Protocol[_ItemType_co]):
    def __len__(self, /) -> int: ...
    def __getitem__(self, index: int, /) -> _ItemType_co | _SimpleNestedSequence[_ItemType_co]: ...

_BytesOrStrType = TypeVar("_BytesOrStrType", bytes, str)

@final
class object_(generic[_ItemType_co], Generic[_ItemType_co]):
    ...
    @overload
    def __new__(cls: type[object_[_BytesOrStrType]], stringy: _BytesOrStrType, /) -> _BytesOrStrType: ...  # type: ignore[misc]
    @overload
    def __new__(cls: type[object_[_T]], array: ndarray[_ShapeType2, dtype[generic[_T]]], /) -> ndarray[_ShapeType2, dtype[object_[_T]]]: ...  # type: ignore[misc]
    @overload
    def __new__(cls: type[object_[_T]], sequence: _SimpleNestedSequence[_T], /) -> NDArray[object_[_T]]: ...  # type: ignore[misc]
    @overload
    def __new__(cls: type[object_[_T]], value: _T, /) -> _T: ...
    # needed because `generic.__init__` is abstract
...
_DeltaUnitType = TypeVar("_DeltaUnitType", bound=_DeltaUnit, default=_DeltaUnit)
_DeltaSpec: TypeAlias = _DeltaUnitType | tuple[_DeltaUnitType, SupportsIndex]

_TD64IntType = TypeVar("_TD64IntType", L[0], int)
_TD64Type_co = TypeVar(
    "_TD64Type_co",
...
class timedelta64(generic[_TD64Type_co], Generic[_TD64Type_co]):
    @overload
    def __init__(self, value: _TD64Type_co | timedelta64[_TD64Type_co], /) -> None: ...
    @overload
    def __init__(self: timedelta64[L[0]], /) -> None: ...
    @overload
    def __init__(self: timedelta64[None], value: _NaTValue | None, format: _DeltaSpec = ..., /) -> None: ...
    @overload
    def __init__(self: timedelta64[_TD64IntType], value: _TD64IntType, format: _DeltaSpec[_DeltaUnitInt] = ..., /) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, value: int | dt.timedelta | _NaTValue | None, format: _DeltaSpec = ..., /) -> None: ...
    ...
    @overload
    def __bool__(self, /) -> builtins.bool: ...
    def __int__(self: timedelta64[_TD64IntType], /) -> _TD64IntType: ...
    def __float__(self: timedelta64[int]) -> float: ...
    def __complex__(self: timedelta64[int]) -> complex: ...
    def __neg__(self, /) -> Self: ...
    def __pos__(self, /) -> Self: ...
    def __abs__(self, /) -> Self: ...
...
_DT64Type_co = TypeVar(
    "_DT64Type_co",
    int, dt.datetime, dt.date, None, int | dt.date | None,
    covariant=True,
    default=int | dt.date | None,
)  # fmt: skip
_DT64DefaultType = TypeVar("_DT64DefaultType", dt.datetime, dt.date, None)
...
class datetime64(generic[_DT64Type_co], Generic[_DT64Type_co]):
    @overload
    def __init__(self, value: datetime64[_DT64Type_co], /) -> None: ...
    @overload
    def __init__(self: datetime64[_DT64DefaultType], value: _DT64DefaultType, /) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, value: _DT64Value_any | _NaTValue | None, format: _DeltaSpec = ..., /) -> None: ...
...
class integer(number[_NBit, int]):  # type: ignore
    @property
    def real(self) -> Self: ...
    @property
    def imag(self) -> Self: ...
...
_InexactType_co = TypeVar("_InexactType_co", float, complex, covariant=True, default=complex)

class inexact(number[_NBit, _InexactType_co], Generic[_NBit, _InexactType_co]): ...  # type: ignore[misc]

_IntType = TypeVar("_IntType", bound=integer[Any])

class floating(inexact[_NBit1, float], Generic[_NBit1]):
...
class flexible(generic[_ItemType_co], Generic[_ItemType_co]): ...  # type: ignore
...
_CharType_co = TypeVar("_CharType_co", bytes, str, bytes | str, covariant=True, default=bytes | str)

class character(flexible[_CharType_co], Generic[_CharType_co]):  # type: ignore
    def __int__(self) -> int: ...
    def __float__(self) -> float: ...
