...
assert_type(np.busday_offset("2011-01", "2011-02", roll="forward"), np.datetime64[dt.datetime])
assert_type(np.busday_offset(["2011-01"], "2011-02", roll="forward"), npt.NDArray[np.datetime64[dt.datetime]])
