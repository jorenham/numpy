...
class object_(generic[_ItemT_co], Generic[_ItemT_co]):
    ...
    def __iter__(self: object_[Iterable[_T]], /) -> Iterator[_T]: ...
    def __contains__(self: object_[_SupportsContains[_KT, _BoolT]], k: _KT, /) -> _BoolT: ...
    def __getitem__(self: object_[_SupportsGetItem[_KT, _T]], k: _KT, /) -> _T: ...
