...
class matrix(np.ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    #
    def __pow__(self, other: ArrayLike, mod: None = None, /) -> _Matrix[Incomplete]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    def __rpow__(self, other: ArrayLike, mod: None = None, /) -> _Matrix[Incomplete]: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
