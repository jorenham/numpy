...
class long(signedinteger[_NBitLong]):
    ...
    @overload
    def __new__(cls, value: _IntValue = ..., /) -> long: ...
    @property
...
class longlong(signedinteger[_NBitLongLong]):
    ...
    def __new__(cls: type[signedinteger[_64Bit]], value: _IntValue = ..., /) -> int64: ...
    @overload
    def __new__(cls, value: _IntValue = ..., /) -> longlong: ...
    @property
    def itemsize(self) -> L[8]: ...
    @property
...
class ulong(unsignedinteger[_NBitLong]):
    @overload
    def __new__(cls: type[unsignedinteger[_32Bit]], value: _IntValue = ..., /) -> ulong: ...
    @overload
...
class ulonglong(unsignedinteger[_NBitLongLong]):
    ...
    def __new__(cls: type[unsignedinteger[_64Bit]], value: _IntValue = ..., /) -> uint64: ...
    @overload
    def __new__(cls, value: _IntValue = ..., /) -> ulonglong: ...
    @property
    def itemsize(self) -> L[8]: ...
    @property
...
class floating(inexact[_NBit1]):
    ...
    def __round__(self, ndigits: None = ..., /) -> int: ...
    @overload
    def __round__(self: _T, ndigits: SupportsIndex, /) -> _T: ...
