...
_DateT = TypeVar("_DateT", bound=dt.date)
...
class datetime64(_RealMixin, generic[_DT64ItemT_co], Generic[_DT64ItemT_co]):
    ...
    def __sub__(self: datetime64[_DateT], x: _DateT, /) -> dt.timedelta: ...
