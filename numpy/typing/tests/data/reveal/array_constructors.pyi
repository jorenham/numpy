...
assert_type(np.arange(False, True), np.ndarray[tuple[int], np.dtype[np.intp]])
assert_type(np.arange(10), np.ndarray[tuple[int], np.dtype[np.intp]])
assert_type(np.arange(0, 10, step=2), np.ndarray[tuple[int], np.dtype[np.intp]])
assert_type(np.arange(10.0), np.ndarray[tuple[int], np.dtype[np.float64]])
assert_type(np.arange(start=0, stop=10.0), np.ndarray[tuple[int], np.dtype[np.float64]])
...
assert_type(np.arange(10, dtype=int), np.ndarray[tuple[int], np.dtype[np.intp]])
...
assert_type(np.ones(_shape_like, dtype=np.dtypes.Int64DType()), np.ndarray[tuple[int, ...], np.dtypes.Int64DType])
