...
from numpy._typing._protocols import *
...
_AnyStr = TypeVar("_AnyStr_contra", bytes, str, LiteralString)
_AnyStr_contra = TypeVar("_AnyStr_contra", bytes, str, LiteralString, contravariant=True)
...
_NDList: TypeAlias = _T | list[_NDList[_T]]
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType_co, _DType_co]):
    ...
    @property
    def real(
        self: ndarray[_ShapeType_co, dtype[_SupportsReal[_SCT]]],  # type: ignore[type-var]
    ) -> ndarray[_ShapeType_co, _dtype[_SCT]]: ...
    @real.setter
    def real(self, value: ArrayLike) -> None: ...
    @property
    def imag(
        self: ndarray[_ShapeType_co, dtype[_SupportsImag[_SCT]]],  # type: ignore[type-var]
    ) -> ndarray[_ShapeType_co, _dtype[_SCT]]: ...
    @imag.setter
    ...
    # @overload
    # def tolist(self: ndarray[tuple[int, int, int, Unpack[tuple[int, ...]]], dtype[generic[_T]]], /) -> list[list[list[_NDList[_T]]]]: ...
    @overload
    def tolist(self: ndarray[tuple[int, ...], dtype[generic[_T]]], /) -> _NDList[_T]: ...

    @overload
    def item(self: ndarray[tuple[L[1], ...], dtype[generic[_T]]], arg: L[0] | tuple[L[0], ...] = ..., /) -> _T: ...
    @overload
    def item(self: NDArray[generic[_T]], /, *args: SupportsIndex) -> _T: ...
    @overload
    def item(self: NDArray[generic[_T]], arg: tuple[SupportsIndex, ...], /) -> _T: ...
...
_ItemT_co = TypeVar("_ItemT_co", covariant=True, default=object)

class generic(_ArrayOrScalarCommon, Generic[_ItemT_co], metaclass=abc.ABCMeta):
    @property
    def base(self) -> None: ...
    @property
    def ndim(self) -> L[0]: ...
    ...
    @overload
    def __array__(self, dtype: None = ..., /) -> ndarray[tuple[()], dtype[Self]]: ...
    @overload
    ...
    def item(self, args: L[0] | tuple[()] | tuple[L[0]] = ..., /) -> _ItemT_co: ...
    ...
    # TODO: handle the cases where this doesn't hold, e.g. `(matrix) -> matrix`
    @overload
...
# NOTE: `complex` is equivalent to `float | complex`, and `float` to `int | float`
_NumberT_co = TypeVar("_NumberT_co", int, float, complex, covariant=True, default=complex)

class number(generic[_NumberT_co], Generic[_NBit, _NumberT_co], metaclass=abc.ABCMeta):
    def __class_getitem__(cls, item: Any, /) -> GenericAlias: ...
...
_BoolT = TypeVar("_BoolT", bound=builtins.bool)
_BoolT_co = TypeVar("_BoolT_co", covariant=True, bound=builtins.bool, default=builtins.bool)

_Falsy: TypeAlias = L[None, False, 0, b"", ""] | np.bool[L[False]]
_Truthy: TypeAlias = L[True, 1] | np.bool[L[True]]

class bool(generic[_BoolT_co], Generic[_BoolT_co]):
    @overload
    def __init__(self: np.bool[L[False]], /) -> None: ...
    @overload
    def __init__(self: np.bool[L[False]], value: _Falsy = ..., /) -> None: ...
    @overload
    def __init__(self: np.bool[L[True]], value: L[True, 1], /) -> None: ...
    @overload
    ...
    def real(self) -> Self: ...
    @property
    def imag(self) -> np.bool[L[False]]: ...  # type: ignore[override]
    @property
    ...
    @overload
    def __index__(self: np.bool[L[False]], /) -> L[0]: ...
    @overload
    def __index__(self: np.bool[L[True]], /) -> L[1]: ...
    @overload
    ...
    @overload
    def __and__(self, other: L[True] | np.bool[L[True]], /) -> np.bool[_BoolT_co]: ...
    @overload
    ...
    @overload
    def __xor__(self: np.bool[L[False]], other: _BoolT | np.bool[_BoolT], /) -> np.bool[_BoolT]: ...
    @overload
    def __xor__(self: np.bool[L[True]], other: L[True] | np.bool[L[True]], /) -> np.bool[L[False]]: ...
    @overload
    def __xor__(self, other: L[False] | np.bool[L[False]], /) -> np.bool[_BoolT_co]: ...
    @overload
    ...
    @overload
    def __or__(self, other: L[False] | np.bool[L[False]], /) -> np.bool[_BoolT_co]: ...
    @overload
...
class object_(generic[_ItemT_co], Generic[_ItemT_co]):
    ...
    @overload
    def __new__(cls: type[object_[None]], nothing_to_see_here: None = ..., /) -> None: ...  # type: ignore[misc]
    @overload
    def __new__(cls: type[object_[_AnyStr]], stringy: _AnyStr, /) -> _AnyStr: ...  # type: ignore[misc]
    @overload
    def __new__(  # type: ignore[misc]
        cls, array: ndarray[_ShapeType, dtype[generic[_ItemT_co]]], /
    ) -> ndarray[_ShapeType, dtype[object_[_ItemT_co]]]: ...
    @overload
    def __new__(cls, sequence: SupportsLenAndGetItem[_ItemT_co], /) -> NDArray[object_[_ItemT_co]]: ...  # type: ignore[misc]
    @overload
    def __new__(cls, value: _ItemT_co, /) -> _ItemT_co: ...  # type: ignore[misc]

    @property
    def real(self: object_[_SupportsReal[_T]]) -> _T: ...
    @property
    def imag(self: object_[_SupportsImag[_T]]) -> _T: ...

    def __hash__(self: object_[Hashable], /) -> int: ...
    def __index__(self: object_[SupportsIndex], /) -> int: ...
    def __bool__(self: object_[_SupportsBool[_BoolT]]) -> _BoolT: ...
    def __int__(self: object_[SupportsInt], /) -> int: ...
    def __float__(self: object_[SupportsFloat], /) -> float: ...
    def __complex__(self: object_[SupportsComplex], /) -> complex: ...
    def __bytes__(self: object_[SupportsBytes], /) -> bytes: ...

    def __abs__(self: object_[SupportsAbs[_T]], /) -> _T: ...
    def __invert__(self: object_[_SupportsInvert[_T]], /) -> _T: ...
    def __neg__(self: object_[_SupportsNeg[_T]], /) -> _T: ...
    def __pos__(self: object_[_SupportsPos[_T]], /) -> _T: ...
    def __round__(self: object_[SupportsRound[_T]], /) -> _T: ...

    def __eq__(self: object_[_SupportsEQ[_VT, _T]], rhs: _VT) -> _T: ...
    def __ne__(self: object_[_SupportsNE[_VT, _T]], rhs: _VT) -> _T: ...
    def __lt__(self: object_[_SupportsLT[_VT, _T]], rhs: _VT) -> _T: ...
    def __le__(self: object_[_SupportsLE[_VT, _T]], rhs: _VT) -> _T: ...
    def __gt__(self: object_[_SupportsGT[_VT, _T]], rhs: _VT) -> _T: ...
    def __ge__(self: object_[_SupportsGE[_VT, _T]], rhs: _VT) -> _T: ...

    def __add__(self: _SupportsAdd[_VT, _T], rhs: _VT, /) -> _T: ...
    def __sub__(self: _SupportsSub[_VT, _T], rhs: _VT, /) -> _T: ...
    def __mul__(self: _SupportsMul[_VT, _T], rhs: _VT, /) -> _T: ...
    def __matmul__(self: _SupportsMatMul[_VT, _T], rhs: _VT, /) -> _T: ...
    def __truediv__(self: _SupportsTrueDiv[_VT, _T], rhs: _VT, /) -> _T: ...
    def __floordiv__(self: _SupportsFloorDiv[_VT, _T], rhs: _VT, /) -> _T: ...
    def __pow__(self: _SupportsPow[_VT, _T], rhs: _VT, /) -> _T: ...
    def __mod__(self: _SupportsMod[_VT, _T], rhs: _VT, /) -> _T: ...
    def __lshift__(self: _SupportsLShift[_VT, _T], rhs: _VT, /) -> _T: ...
    def __rshift__(self: _SupportsRShift[_VT, _T], rhs: _VT, /) -> _T: ...
    def __and__(self: _SupportsAnd[_VT, _T], rhs: _VT, /) -> _T: ...
    def __xor__(self: _SupportsXOr[_VT, _T], rhs: _VT, /) -> _T: ...
    def __or__(self: _SupportsOr[_VT, _T], rhs: _VT, /) -> _T: ...

    def __radd__(self: _SupportsRAdd[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rsub__(self: _SupportsRSub[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rmul__(self: _SupportsRMul[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rmatmul__(self: _SupportsRMatMul[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rtruediv__(self: _SupportsRTrueDiv[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rfloordiv__(self: _SupportsRFloorDiv[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rmod__(self: _SupportsRMod[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rpow__(self: _SupportsRPow[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rlshift__(self: _SupportsRLShift[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rrshift__(self: _SupportsRRShift[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rand__(self: _SupportsRAnd[_VT, _T], lhs: _VT, /) -> _T: ...
    def __rxor__(self: _SupportsRXOr[_VT, _T], lhs: _VT, /) -> _T: ...
    def __ror__(self: _SupportsROr[_VT, _T], lhs: _VT, /) -> _T: ...

    def __len__(self: object_[Sized], /) -> int: ...
    def __contains__(self: object_[_SupportsContains[_T, _BoolT]], k: _T, /) -> _BoolT: ...
    def __getitem__(self: object_[_SupportsGetItem[_KT, _VT]], k: _KT, /) -> _VT: ...
    def __iter__(self: object_[_SupportsIter[_T]], /) -> _T: ...
    def __aiter__(self: object_[_SupportsAIter[_T]], /) -> _T: ...
    def __await__(self: object_[_SupportsAwait[_T]], /) -> _T: ...
...
_NaTValue: TypeAlias = L[
    "NAT", "NAt", "NaT", "Nat", "nAT", "nAt", "naT", "nat",
    b"NAT", b"NAt", b"NaT", b"Nat", b"nAT", b"nAt", b"naT", b"nat",
]  # fmt: skip

_DateUnitMonth: TypeAlias = L["Y", "M", b"Y", b"M"]
_DateUnitDay: TypeAlias = L["W", "D", b"W", b"D"]
_DateUnit: TypeAlias = L[_DateUnitMonth, _DateUnitDay]

_TimeUnitMicro: TypeAlias = L["h", "m", "s", "ms", "us", "μs", b"h", b"m", b"s", b"ms", b"us"]
_TimeUnitAtto: TypeAlias = L["ns", "ps", "fs", "as", b"ns", b"ps", b"fs", b"as"]
_TimeUnit: TypeAlias = L[_TimeUnitMicro, _TimeUnitAtto]

_DeltaUnitInt: TypeAlias = L[_DateUnitMonth, _TimeUnitAtto]
_DeltaUnitTD: TypeAlias = L[_DateUnitDay, _TimeUnitMicro]
_DeltaUnit: TypeAlias = L[_DateUnit, _TimeUnit]

_DeltaUnitT = TypeVar("_DeltaUnitT", bound=_DeltaUnit, default=_DeltaUnit)
_DeltaSpec: TypeAlias = _DeltaUnitT | tuple[_DeltaUnitT, SupportsIndex]

_TD64IntT = TypeVar("_TD64IntT", L[0], int)
_TD64T_co = TypeVar(
    "_TD64T_co",
    L[0], int, dt.timedelta, None, int | dt.timedelta | None,
    covariant=True,
    default=int | dt.timedelta | None,
)  # fmt: skip

class timedelta64(generic[_TD64T_co], Generic[_TD64T_co]):
    @overload
    def __init__(self, value: _TD64T_co | timedelta64[_TD64T_co], /) -> None: ...
    @overload
    def __init__(self: timedelta64[L[0]], /) -> None: ...
    @overload
    def __init__(self: timedelta64[None], value: _NaTValue | None, format: _DeltaSpec = ..., /) -> None: ...
    @overload
    def __init__(self: timedelta64[_TD64IntT], value: _TD64IntT, format: _DeltaSpec[_DeltaUnitInt] = ..., /) -> None: ...
    @overload
    def __init__(self: timedelta64[int], value: dt.timedelta, format: _DeltaSpec[_TimeUnitAtto] = ..., /) -> None: ...
    @overload
    def __init__(self: timedelta64[dt.timedelta], value: dt.timedelta, format: _DeltaSpec[_DeltaUnitTD] = ..., /) -> None: ...
    @overload
    def __init__(self, value: int | bytes | str | dt.timedelta | None, format: _DeltaSpec = ..., /) -> None: ...
    ...
    @overload
    def __bool__(self: timedelta64[L[0]], /) -> L[False]: ...
    @overload
    def __bool__(self: timedelta64[None], /) -> L[True]: ...
    @overload
    def __bool__(self, /) -> builtins.bool: ...
    def __int__(self: timedelta64[_TD64IntT], /) -> _TD64IntT: ...
    def __float__(self: timedelta64[int], /) -> float: ...
    def __neg__(self, /) -> Self: ...
    def __pos__(self, /) -> Self: ...
    def __abs__(self, /) -> Self: ...

    # TODO: unit-specific overloads to e.g. prevent adding `m[Y]` and `m[W]`
    # and to propagate `L[0]` values
...
# NOTE: `dt.date` is equivalent to `dt.datetime | dt.date`
_DT64T_co = TypeVar(
    "_DT64T_co",
    int, dt.datetime, dt.date, None, int | dt.date | None,
    covariant=True,
    default=int | dt.date | None,
)  # fmt: skip
_DT64DefaultT = TypeVar("_DT64DefaultT", dt.datetime, dt.date, None)
_DT64Value_date: TypeAlias = _SupportsDate | L["TODAY", "Today", "today", b"TODAY", b"Today", b"today"]
_DT64Value_time: TypeAlias = L["NOW", "Now", "now", b"NOW", b"Now", b"now"]
_DT64Value_any: TypeAlias = int | bytes | str

class datetime64(generic[_DT64T_co], Generic[_DT64T_co]):
    @overload
    def __init__(self, value: datetime64[_DT64T_co], /) -> None: ...
    @overload
    def __init__(self: datetime64[_DT64DefaultT], value: _DT64DefaultT, /) -> None: ...
    @overload
    def __init__(self: datetime64[None], value: _NaTValue | None = ..., format: _DeltaSpec = ..., /) -> None: ...
    @overload
    def __init__(self: datetime64[dt.datetime], value: _DT64Value_time, format: _DeltaSpec[_TimeUnitMicro] = ..., /) -> None: ...
    @overload
    def __init__(self: datetime64[dt.date], value: _DT64Value_date, format: _DeltaSpec[_DateUnit] = ..., /) -> None: ...
    @overload
    def __init__(self: datetime64[int], value: _DT64Value_any, format: _DeltaSpec[_TimeUnitAtto], /) -> None: ...
    @overload
    def __init__(self: datetime64[dt.datetime], value: _DT64Value_any, format: _DeltaSpec[_TimeUnitMicro], /) -> None: ...
    @overload
    def __init__(self: datetime64[dt.date], value: _DT64Value_any, format: _DeltaSpec[_DateUnit], /) -> None: ...
    @overload
    def __init__(self, value: bytes | str | None, format: _DeltaSpec = ..., /) -> None: ...
...
_ComplexValue: TypeAlias = (
    ...
    | SupportsComplex
    | SupportsIndex
    | complex  # `complex` is not a subtype of `SupportsComplex` before python 3.11
)

class integer(number[_NBit, int], metaclass=abc.ABCMeta):
    @property
    def real(self) -> Self: ...
    @property
    def imag(self) -> Self: ...
...
class signedinteger(integer[_NBit1], metaclass=abc.ABCMeta):
...
class unsignedinteger(integer[_NBit1], metaclass=abc.ABCMeta):
...
# NOTE: `complex` is equivalent to `float | complex`
_InexactT_co = TypeVar("_InexactT_co", float, complex, covariant=True, default=complex)
_IntegerT = TypeVar("_IntegerT", bound=integer[Any])

class inexact(number[_NBit, _InexactT_co], Generic[_NBit, _InexactT_co], metaclass=abc.ABCMeta): ...

class floating(inexact[_NBit1, float], Generic[_NBit1], metaclass=abc.ABCMeta):
...
class complexfloating(inexact[_NBit1, complex], Generic[_NBit1, _NBit2], metaclass=abc.ABCMeta):
...
class flexible(generic[_ItemT_co], Generic[_ItemT_co], metaclass=abc.ABCMeta):
    @abc.abstractmethod
    def __init__(self, value: Any = ..., /) -> None: ...

# TODO(jorenham): Make generic; either as `bytes` or `tuple[object, ...]`
# see https://numpy.org/doc/stable/user/basics.rec.html#structured-datatypes
...
_CharT_co = TypeVar("_CharT_co", covariant=True, bound=bytes | str, default=bytes | str)

class character(flexible[_CharT_co], Generic[_CharT_co], metaclass=abc.ABCMeta):
    def __int__(self) -> int: ...
    def __float__(self) -> float: ...
...
class bytes_(bytes, character[bytes]):
    @overload
    def __init__(self, value: object = ..., /) -> None: ...
    @overload
    def __init__(self, value: str, /, encoding: str = ..., errors: str = ...) -> None: ...

class str_(str, character[str]):
    @overload
    def __init__(self, value: object = ..., /) -> None: ...
    @overload
...
class matrix(ndarray[_Shape2DType_co, _DType_co]):
    ...
    def tolist(self: matrix[_Shape2D, dtype[generic[_T]]]) -> list[list[_T]]: ...  # type: ignore[typevar]
